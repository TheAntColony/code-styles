# Chime Employee Engagement

 Android app that will be used at [chimesolutions](http://chimesolutions.com) as a internal solution for employee engagement. It demonstrates the architecture, tools and guidelines that we use when developing for the Android platform.
...
```
    Copyright 2018 ChimeSolutions Ltd.
