# 1. Project and code style guidelines
...
```java
Picasso.with(context).load("http://antcolony.io/images/sexyAmar.jpg").into(imageView);
```

```java
Picasso.with(context)
        .load("http://http://antcolony.io/sexyAmar.jpg")
        .into(imageView);
```
...
```java
loadPicture(context, "http://antcolony.io/sexyAmar.jpg", mImageViewProfilePicture, clickListener, "Title of the picture");
```

```java
loadPicture(context,
        "http://antcolony.io/sexyAmar.jpg",
...
```
Copyright 2017 AntColony d.o.o
